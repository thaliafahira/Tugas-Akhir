...
\begin{enumerate}
    ...
    \item Bagaimana merancang sistem \textit{front-end} yang dapat diintegrasikan secara efektif dengan sistem \textit{back-end} untuk menyajikan visualisasi data posisi ribuan pelari secara informatif dan responsif?
...
\begin{enumerate}
    ...
    \item Terjalinnya integrasi antara \textit{front-end} dan \textit{back-end} yang efektif, di mana data dari API dapat ditampilkan tanpa gangguan signifikan sehingga proses pelacakan dapat dilakukan secara lancar.
\end{enumerate}
% --- Batasan Masalah ---
