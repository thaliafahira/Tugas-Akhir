...
\begin{enumerate}
    ...
    \item Hasil evaluasi menunjukkan bahwa \textit{front-end} sistem pelacak yang dikembangkan memiliki tingkat kemudahan penggunaan (\textit{usability}) yang baik dalam mendukung pemantauan peserta selama kegiatan ITB Ultra-Marathon.
\end{enumerate}
Penelitian ini dinyatakan berhasil apabila memenuhi kriteria sebagai berikut.
\begin{enumerate}
    \item Berhasil menghasilkan \textit{front-end} sistem pelacak yang mampu memvisualisasikan posisi dan pergerakan peserta secara \textit{real-time}.
...
\begin{enumerate}
    ...
    Memaparkan landasan teori dan kajian pustaka yang relevan, mencakup konsep \textit{ultra-marathon}, pengembangan \textit{front-end}, teknologi pelacakan, serta literatur mengenai sistem pendukung perlombaan lari jarak jauh.
    ...
    Menguraikan perancangan solusi yang diusulkan, meliputi arsitektur sistem secara menyeluruh, desain antarmuka pengguna, serta perancangan integrasi antara sisi \textit{front-end} dengan \textit{back-end}.
    \item Bab V Implementasi\\
    Menjelaskan proses realisasi atau pengkodean antarmuka aplikasi berdasarkan rancangan yang telah dibuat, termasuk penggunaan teknologi, kerangka kerja (\textit{framework}), serta pustaka (\textit{library}) yang digunakan untuk memvisualisasikan data pelacakan.
