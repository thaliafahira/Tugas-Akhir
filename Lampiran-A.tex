...
Lampiran ini menyajikan (\textit{screenshot}) hasil implementasi antarmuka \textit{front-end} aplikasi \textit{tracker} ITB Ultra-Marathon pada dua platform, yaitu aplikasi \textit{mobile} dan aplikasi web.
% ============================================================
% Pastikan package berikut ada di preamble dokumen utama:
% \usepackage{array}
% ============================================================
...
\begin{longtable}{|>{\raggedright\arraybackslash}m{4.2cm}|>{\centering\arraybackslash}m{6cm}|}
\caption*{Tabel A.1 Hasil Implementasi Antarmuka Aplikasi \textit{Mobile}} \\
\hline
\multicolumn{1}{|c|}{\textbf{Fitur}} & \multicolumn{1}{c|}{\textbf{Gambar}} \\ \hline
\endfirsthead
\hline
\multicolumn{1}{|c|}{\textbf{Fitur}} & \multicolumn{1}{c|}{\textbf{Gambar}} \\ \hline
\endhead
...
\includegraphics[width=0.95\linewidth,keepaspectratio]{images/implementasi/web/public-home.png} \\ \hline

Panel detail pelari yang muncul saat pengguna mengeklik penanda (\textit{marker}) pelari pada peta &
\includegraphics[width=0.95\linewidth,keepaspectratio]{images/implementasi/web/public-runner.png} \\ \hline
...
\includegraphics[width=0.95\linewidth,keepaspectratio]{images/implementasi/web/public-location.png} \\
...
\includegraphics[width=0.95\linewidth,keepaspectratio]{images/implementasi/web/ketua-home.png} \\ \hline

Halaman manajemen tim untuk mengatur rotasi pelari dan membuat tautan untuk \textit{supporter} dan penonton &
\includegraphics[width=0.95\linewidth,keepaspectratio]{images/implementasi/web/ketua-manage.png} \\
...
\includegraphics[width=0.95\linewidth,keepaspectratio]{images/implementasi/web/support-home.png} \\ \hline

Halaman manajemen \textit{supporter} untuk memilih peserta yang dipantau dan mengakses navigasi ke lokasi pelari &
\includegraphics[width=0.95\linewidth,keepaspectratio]{images/implementasi/web/support-manage.png} \\
...
\includegraphics[width=0.95\linewidth,keepaspectratio]{images/implementasi/web/panitia-dasahboard.png} \\ \hline

Tampilan peta global yang memperlihatkan posisi seluruh pelari dari semua tim secara bersamaan &
\includegraphics[width=0.95\linewidth,keepaspectratio]{images/implementasi/web/panitia-map.png} \\ \hline

Halaman \textit{command center} darurat yang menampilkan peringatan SOS berkedip beserta koordinat pelari &
\includegraphics[width=0.95\linewidth,keepaspectratio]{images/implementasi/web/panitia-alert.png} \\ \hline

Halaman daftar pelari yang menampilkan status seluruh peserta perlombaan secara terpusat &
\includegraphics[width=0.95\linewidth,keepaspectratio]{images/implementasi/web/panitia-runner.png} \\ \hline

Halaman daftar tim yang menampilkan informasi dan susunan anggota dari setiap tim yang terdaftar &
\includegraphics[width=0.95\linewidth,keepaspectratio]{images/implementasi/web/panitia-team.png} \\ \hline

Halaman statistik perlombaan yang menampilkan rekapitulasi performa perlombaan secara \textit{real-time} &
\includegraphics[width=0.95\linewidth,keepaspectratio]{images/implementasi/web/panitia-stats.png} \\
...
\includegraphics[width=0.95\linewidth,keepaspectratio]{images/implementasi/web/private-home.png} \\
