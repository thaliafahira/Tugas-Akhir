...
TC-09 & Pelari \textit{inactive} & Peta memfokuskan (\textit{spectating}) pelari lain dalam tim yang sama & Berhasil \\ \hline

TC-10 & Pelari bergerak menggunakan GPS aktual & Posisi pelari diperbarui sesuai perpindahan lokasi sebenarnya serta ETA, jarak tersisa, waktu tempuh, dan \textit{pace} dihitung dengan benar & Berhasil \\ \hline

TC-11 & Pelari bergerak menggunakan aplikasi \textit{Fake GPS Simulator Joystick} & Posisi pelari diperbarui sesuai lokasi simulasi sehingga seluruh fitur yang bergantung pada data lokasi berfungsi dengan benar & Berhasil \\ \hline
